export const WORDSDICT: {[key:string]:string } = {
   ...
   'death': 'The Seeds of Death, The Ambassadors of Death, The Green Death, Death to the Daleks, The Robots of Death, City of Death, and Death in Heaven are all Doctor Who stories.',
