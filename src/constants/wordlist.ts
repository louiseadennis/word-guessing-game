export const WORDSDICT: {[key:string]:string } = {
   ...
   'duffy': 'Charlie Duffy was the villain in Kerblam!',
   ...
   'ikona': 'Ikona is instrumental to helping the Doctor defeat the Rani in Time and the Rani.',
   ...
   'queen': 'The milk of the Queen Bat is a cure for Spectrox Toxaemia in THe Caves of Androzani.  The Doctor also married Queen Elizabeth I and was exiled by Queen Victoria.',
   ...
   'engin': 'Co-ordinaor Engin is in charge of the Matrix in The Deadly Assassin.',
   ...
   'chalk': 'In Battlefield, Ace and Shou Yuing hold of the Destroyer with a chalk circle.',
   ...
   'kemel': 'Kemel is a servant of the Maxfield\'s in The Evil of the Daleks who helps Jamie rescue Victroia.',
   ...
   'sigma': 'Theta Sigma is the Doctor\'s nickname at the Time Lor academy.  In the Happiness Patrol all aliens are designated Sigma.  Later Ood Sigma is instramental in freeing the Ood.',
   ...
   'maren': 'Maren is leader of the Sisterhood of Karnn in The Brain of Morbius.',
   ...
   'above': 'He who to Rassilon\'s Tower would go much choose above, between, below.',
   ...
   'tomas': 'Tomas is a Sevateem friend of Leela in The Face of Evil.',
   ...
   'cully': 'Cully is the one adventurous Dukian in The Dominators.',
   ...
   'zocci': 'Bannakaffalatta from Vogage of the Damned was a Zocci.',
   ...
   'shura': 'Is a rebel time traveller from the Daleks in Day of the Daleks who nearly creates a bootstrap paradox.',
   ...
   'latep': 'Latep is a Thal who asks Jo Grant to leave the Doctor and stay with him (she doesn\'t).',
   ...
   'rodan': 'Female Gallifreyan Traffic Controller who helps the Doctor and Leela in the Invasion of Time.',
   ...
   'raaga': 'The penal planet of the Tereleptils.',
   ...
   'neeva': 'Neeva is the priest of the Sevateem in The Face of Evil.',
   ...
   'stein': 'Stein betrays the Doctor in Resurrection of the Daleks.',
   ...
   'dyoni': 'Dyoni is a Thal in The Daleks.',
   ...
   'linda': 'The London Investigation \'n\' Detective Agency seeks to learn more about the Doctor in Love & Monsters.',
